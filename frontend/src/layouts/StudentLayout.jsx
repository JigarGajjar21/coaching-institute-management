...
const NAV = [
  ...
  { path: '/dashboard/marks',      label: 'Marks',      icon: '🏆' },
  { path: '/dashboard/materials',  label: 'Materials',  icon: '📁' },
];
    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#0B0B0F', fontFamily: 'Inter, sans-serif', color: '#fff' }}>
      ...
      <aside style={{
        ...
        <div style={{ padding: collapsed ? '20px 0' : '20px', display: 'flex', alignItems: 'center', gap: 10, borderBottom: '1px solid rgba(255,255,255,0.06)', justifyContent: collapsed ? 'center' : 'flex-start' }}>
          ...
          {!collapsed && <span style={{ fontWeight: 800, fontSize: '0.95rem', letterSpacing: '-0.02em', whiteSpace: 'nowrap' }}>Student Portal</span>}
        </div>
        ...
        <nav style={{ flex: 1, padding: '12px 8px', overflowY: 'auto', overflowX: 'hidden' }}>
          ...
          <Link to="/courses" style={{
            ...
            color: '#52525B', fontSize: '0.875rem', textDecoration: 'none', transition: 'all 0.2s', whiteSpace: 'nowrap',
          }}
          onMouseOver={e => { e.currentTarget.style.color='#22D3A5'; e.currentTarget.style.background='rgba(34,211,165,0.06)'; }}
          onMouseOut={e => { e.currentTarget.style.color='#52525B'; e.currentTarget.style.background='transparent'; }}
          >
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '0.72rem', color: '#52525B' }}>Student Portal</div>
            </div>
          </div>
